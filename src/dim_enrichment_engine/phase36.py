...
def generate_reports(weapons: Path, armor: Path, loadouts: Path | None, output_dir: Path, use_bungie: bool) -> None:
    ...
    export_payload = {'stat_optimization': stat_payload, 'build_recommendation': build_payload}
...
def main() -> None:
    parser = argparse.ArgumentParser(description='DIM Intelligence Engine Phase 3.6')
